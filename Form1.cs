...
namespace ProyectoFinalHMI_23
{
    public partial class Form1 : Form
    {
        ...
        private void buttonConnect_Click(object sender, EventArgs e)
        {
            ...
            if (!serialPort1.IsOpen)
            {
                try
                {
                    ...
                    listBoxLog.Items.Add("Conectado a " + serialPort1.PortName);
                }
                catch (Exception ex)
                {
            ...
            else
            {
                ...
                labelEstadoConexion.Text = "DISCONNECTED";
                labelEstadoConexion.ForeColor = Color.Red;

                listBoxLog.Items.Add("Desconectado");
            }
        }
        ...
        {
            data = data.Trim();
            listBoxLog.Items.Add("Arduino → " + data);
